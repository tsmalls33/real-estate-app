  ...
  return (
    <div className="grid gap-[18px] max-w-[640px]">
      <section className="bg-surface border border-border rounded-[14px] px-6 py-[22px]">
        ...
        <div className="grid grid-cols-[140px_1fr] max-[599px]:grid-cols-1 gap-3 items-center py-[10px] text-[13px] border-t border-border first-of-type:border-t-0 first-of-type:pt-0">
