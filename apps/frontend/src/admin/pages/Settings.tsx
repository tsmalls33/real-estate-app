  ...
  return (
    <div className="grid gap-[18px] max-w-[720px]">
      <section className="bg-surface border border-border rounded-radius px-6 py-[22px]">
        ...
        <div className="grid grid-cols-[140px_1fr] max-card:grid-cols-1 gap-3 items-center text-[13px] py-2 border-t border-border first-of-type:border-t-0 first-of-type:pt-0">
        ...
        <section className="bg-surface border border-border rounded-radius px-6 py-[22px]">
          ...
          <form className="flex flex-col gap-[14px]" onSubmit={saveTheme}>
            {(['backgroundColor', 'brandColor', 'secondaryColor'] as ColorKey[]).map(key => {
              ...
              return (
                <div key={key} className="grid grid-cols-[160px_1fr] max-card:grid-cols-1 items-center gap-3">
