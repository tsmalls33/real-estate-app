...
export default function AdminShell() {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-surface-2">
      <header role="banner" className="sticky top-0 z-30 h-[56px] flex items-stretch bg-surface backdrop-blur-md border-b border-border" style={{ background: 'color-mix(in srgb, var(--surface) 86%, transparent)' }}>
