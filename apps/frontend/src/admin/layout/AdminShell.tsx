...
import { faGauge, faBuilding, faGear, faBars } from '@fortawesome/free-solid-svg-icons';
  ...
  return (
    <div className="flex flex-col min-h-screen bg-surface-2">
      <header className="h-[56px] flex items-stretch bg-surface border-b border-border">
        <div className="w-[236px] flex-shrink-0 flex items-center gap-[11px] px-[16px] shadow-[inset_0_-2px_0_var(--brand-secondary)] max-[899px]:w-auto max-[899px]:px-[12px]">
        ...
        <button
          ...
          className="hidden max-[899px]:grid place-items-center w-[44px] flex-shrink-0 text-text-muted hover:text-text"
          onClick={() => setDrawerOpen(true)}
        >
          <FontAwesomeIcon icon={faBars} />
        </button>

        <div className="flex-1 flex items-center justify-between px-[24px] min-w-0 max-[899px]:px-[12px]">
          <div>
